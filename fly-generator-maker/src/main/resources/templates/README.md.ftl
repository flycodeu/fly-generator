...
```
generator generate <#list modelConfig.models as modelInfo><#if modelInfo.groupKey??><#list modelInfo.models as subModelInfo><#if subModelInfo.abbr??></#if></#list><#else><#if modelInfo.abbr??> -${modelInfo.abbr} <#else> -${modelInfo.fieldName} </#if></#if></#list>
```
