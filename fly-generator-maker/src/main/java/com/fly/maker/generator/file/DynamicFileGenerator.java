...
public class DynamicFileGenerator {
    ...
    /**
     * 相对输入路径
     * @param relateInputPath 相对输入路径
     * @param outputPath
     * @param model
     * @throws IOException
     * @throws TemplateException
     */
    public static void doGenerate(String relateInputPath, String outputPath, Object model) throws IOException, TemplateException {
        ...
        // 获取模板所属包的包名以及文件名
        int lastSpringIndex = relateInputPath.lastIndexOf("/");
        String basePackagePath = relateInputPath.substring(0, lastSpringIndex);
        String templateName = relateInputPath.substring(lastSpringIndex + 1);
        // 通过类加载器得到相对的路径
