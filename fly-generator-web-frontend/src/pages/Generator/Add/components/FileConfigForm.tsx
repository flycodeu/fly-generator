...
export default (props: Props) => {
  ...
  const singleFieldFormView = (
    ...
    return (
      <Space key={field.key}>
        <Form.Item label="输入文件路径" name={[field.name, 'inputPath']}>
          <Input />
        </Form.Item>
        <Form.Item label="输出文件路径" name={[field.name, 'outputPath']}>
          <Input />
        </Form.Item>
  ...
  return (
    <>
      <Alert message={'如果不需要修改可以不填写'} type={'warning'} closable={true}></Alert>
